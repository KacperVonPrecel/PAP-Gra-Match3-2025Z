...
public class HoneyTrigger extends OneMainBlockCharacter {
    //XXX
    ...
    private static final Match3Block.BlockType MAIN_BLOCK = Match3Block.BlockType.CITRINE;

    public HoneyTrigger() {
        super(CharacterType.HONEY_TRIGGER, BASE_HEALTH, BASE_DAMAGE, HEALTH_PER_LEVEL_INCREASE, DAMAGE_PER_LEVEL_INCREASE, MAIN_BLOCK);
    }
}