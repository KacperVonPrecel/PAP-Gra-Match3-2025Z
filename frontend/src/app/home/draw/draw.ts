...
export class Draw {
  ...
  private _drawData: DrawData[] = [
    { name: DrawType.COMMON,
      price: 25,
      description: 'standard probabilities'
    },
    { name: DrawType.UNCOMMON,
      price: 50,
      description: 'higher propability for rare characters'
    },
    { name: DrawType.RARE,
      price: 100,
      description: 'very high propability for rare characters'
    }
  ];
